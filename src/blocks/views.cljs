(ns blocks.views
  (:require
   [blocks.components.editor :refer [editor]]
   [blocks.components.editor-output :refer [editor-output]]
...
(defn main-panel []
  (let [name (re-frame/subscribe [::subs/name])]
    (fn []
      [:div
       [:div {:style {:width "1200px" :height "800px" :display "flex" :justify-content "space-between"}}
        [editor]
        [editor-output]]])))
